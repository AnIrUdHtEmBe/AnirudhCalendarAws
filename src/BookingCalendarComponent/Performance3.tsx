...
const applyAction = async (action: CellState) => {
  ...
  useEffect(() => {
    if (firstSelected) {
      ...
      // When no cell is selected, disable toggle
      setIsToggleEnabled(false);
    }
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      {/* Bottom Bar - Fixed */}
      <div className="w-full bg-white px-6 py-3 shadow-md flex shrink-0 text-sm">
        <div className="flex w-full divide-x divide-gray-200">
          {/* Left Section: Booking Info */}
          <div className="flex-1 px-4">
            {firstSelected && (
              <>
                <h3 className="font-bold underline mb-2">Booking:</h3>
  ...
  {selected.length === 0
    ...
    : formatSelectedTimeRange(selected)}
                    ...
                    {selected.length > 0
                      ? selectedCellDetails.currentBooking &&
                        ...
                        ? "'" +
                          ...
                          "'"
                        : selectedCellDetails.availableSports
                            .map((sport) => "'" + sport.name + "' ")
                            .join("")
                      : ""}
                  </p>
                  <p className="mb-2 text-timeSlot">
            ...
            {firstSelected && (
              <>
                <div className="flex items-center mb-2">
                  <h3 className="font-bold underline">Game:</h3>
                ...
                >
                  {!["occupied", "blocked", "booking"].includes(
                    ...
                    <p className="text-sm">No game information available.</p>
                  )}
                </div>
              </>
            )}
          ...
          <div className="flex-1 px-4">
            {firstSelected && (
              <>
                <h3 className="font-bold underline mb-2">Actions:</h3>
